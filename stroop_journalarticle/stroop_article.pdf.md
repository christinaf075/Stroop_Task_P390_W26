...
```{.r .cell-code}
print("First few reaction_time values:")
```

::: {.cell-output .cell-output-stdout}

```
[1] "First few reaction_time values:"
```
...
```{.r .cell-code}
print(head(data$reaction_time))
```

::: {.cell-output .cell-output-stderr}

```
Warning: Unknown or uninitialised column: `reaction_time`.
```
...
```{.r .cell-code}
mean_rt <- mean(data$reaction_time, na.rm = TRUE)
```
...
```
Warning in mean.default(data$reaction_time, na.rm = TRUE): argument is not
...
```
([<matplotlib.axis.XTick object at 0x7c04c2208f40>, <matplotlib.axis.XTick object at 0x7c04c6b824a0>, <matplotlib.axis.XTick object at 0x7c04c21c2650>], [Text(0, 0, 'Trial 1'), Text(1, 0, 'Trial 2'), Text(2, 0, 'Trial 3')])
```
...
```
([<matplotlib.axis.XTick object at 0x7c04c2139270>, <matplotlib.axis.XTick object at 0x7c04c21391e0>, <matplotlib.axis.XTick object at 0x7c04c20c0790>], [Text(0, 0, 'Trial 1'), Text(1, 0, 'Trial 2'), Text(2, 0, 'Trial 3')])
```
