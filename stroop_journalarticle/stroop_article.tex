...
sharply between Trial 1 (M = 1.63s) and Trial 2 (M = 1.1s) before
evening out in Trial 3 (M = 1.1s). Figure~\ref{fig-rt-congruency}
...
1.16s). Trial 3 followed this same trend with congruent words (M =
1.01s) being lower than incongruent words (M = 1.14s). However, unlike
...
about 0.86. Shown in Figure~\ref{fig-acc-overall}, accuracy in Trial 1
starts off fairly low (M = 0.82\%) and rises steadily through Trial 2 (M
= 0.88\%) and reaches a peak at Trial 3 (M = 0.9\%). When compared to
...
accuracy (M = 0.97\%) and incongruent accuracy (M = 0.85\%). Although
